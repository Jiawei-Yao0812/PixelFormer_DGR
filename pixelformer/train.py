...
from utils2 import post_process_depth, flip_lr, OptimalTransportDepthLoss, compute_errors, eval_metrics, \
                       block_print, enable_print, normalize_result, inv_normalize, convert_arg_line_to_args                     
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    otdl_criterion = OptimalTransportDepthLoss()
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            if global_step and global_step % args.log_freq == 0 and not model_just_loaded:
                ...
                if not args.multiprocessing_distributed or (args.multiprocessing_distributed
                    ...
                    writer.add_scalar('otdl_loss', loss, global_step)
